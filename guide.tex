...
%-------------------------------------------------------------------------------- %
% Warn the use of obsolete commands
...
\usepackage[all, warning]{onlyamsmath}% Warn the use of non-ams­math math­e­mat­ics markup
...
%-------------------------------------------------------------------------------- %
%\title{<japanese_title>}{<english_title>}
\title{IPSJ全国大会用クラスファイルの使い方}{How to use the class file for the national convention of IPSJ}
%\author{<japanese_name>}{<english_name>}{<affiliation_label>[,<additional_affiliation>,...]}
\author{山田 太郎}{Tarou Yamada}{IE}
\author{山田 花子}{Hanako Yamada}{I}
\author{鈴木 太郎}{Tarou Suzuki}{I,IS}
%\affiliation{<affiliation_label>}{<japanese_affiliation>}{<english_affiliation>}
